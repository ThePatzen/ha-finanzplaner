...
| [`coordinator.py`](../../../custom_components/finanzplaner/coordinator.py) | [`tests/test_reminders.py`](../../../tests/test_reminders.py), plus relevant data-flow coverage in [`tests/test_finanzplaner_core.py`](../../../tests/test_finanzplaner_core.py) and [`tests/test_account_import.py`](../../../tests/test_account_import.py) |
...
| [`sensor.py`](../../../custom_components/finanzplaner/sensor.py), [`binary_sensor.py`](../../../custom_components/finanzplaner/binary_sensor.py), [`services.py`](../../../custom_components/finanzplaner/services.py) | [`tests/test_reminders.py`](../../../tests/test_reminders.py), plus relevant core/account contracts in [`tests/test_finanzplaner_core.py`](../../../tests/test_finanzplaner_core.py), [`tests/test_account_import.py`](../../../tests/test_account_import.py), and [`tests/test_account_payloads.py`](../../../tests/test_account_payloads.py) |
